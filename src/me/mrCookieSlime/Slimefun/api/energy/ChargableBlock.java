...
// Source File Name:   ChargableBlock.java
...
public class ChargableBlock
{
    ...
    public static int getDefaultCapacity(Location l)
    {
        ...
        return id != null ? ((Integer)max_charges.get(id)).intValue() : 0;
    }
    ...
    {
        return (new StringBuilder(String.valueOf(DoubleHandler.getFancyDouble(getCharge(b))))).append(" J").toString();
    }
