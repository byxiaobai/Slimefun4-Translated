...
// Source File Name:   ChargedItem.java
...
public class ChargedItem extends SlimefunItem
{
    ...
    public ChargedItem(Category category, ItemStack item, String name, RecipeType recipeType, ItemStack recipe[], String chargeType, String keys[], 
            Object values[])
    {
